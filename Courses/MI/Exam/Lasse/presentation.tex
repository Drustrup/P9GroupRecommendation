...
% PUT INPUTS HERE
\input{slides/background/background.tex}
%\input{slides/relatedwork/relatedwork.tex}
\input{slides/theory/theory.tex}
%\input{slides/evaluation/evaluation.tex}
\input{slides/result/result.tex}
