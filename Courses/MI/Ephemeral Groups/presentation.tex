...
\title[Recommending New Items to Ephemeral Groups
Using Contextual User Influence]{TrashVision}
\author[\insertframenumber /\inserttotalframenumber]{Lasse D. Christensen}

\begin{frame}
\Large Recommending New Items to Ephemeral Groups
Using Contextual User Influence\\
\small RecSys 2016, Elisa Quintarelli, Emanuele Rabosio and Letizia Tanca\\
\end{frame}
