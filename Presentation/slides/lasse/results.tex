...
\begin{tikzpicture}
 \begin{axis}[
	...
	ymajorgrids = true,]
     ...
     \end{axis}
\end{tikzpicture}\captionof{figure}{From the report}
\end{minipage}
\begin{minipage}{.46\textwidth}\centering
\begin{tikzpicture}
 \begin{axis}[
	...
	ymajorgrids = true,]
        ...
        %\legend{BC, BTC, BWC, BEC, Random}
     \end{axis}
\end{tikzpicture}\captionof{figure}{The new result}
\end{minipage}
\end{figure}
\end{frame}
	...
	\begin{table}[h]
		...
		\begin{minipage}{.48\textwidth}\centering
			...
			\begin{tabular}{|l|lllll|}
				\hline
						& BC 	 & BTC 		& BWC  		& BEC  		& RS  		\\ \hline
				Size 4	& 0.6398 & 0.6394   & 0.6394 	& 0.6453	& 0.5451	\\ \hline
			\end{tabular}}
		\end{minipage}
		\hfill
		\begin{minipage}{.48\textwidth}\centering
			...
			\begin{tabular}{|l|lllll|}
				\hline
						& BC 	 & BTC 		& BWC  		& BEC  		& RS  		\\ \hline
				Size 12	& 0.5573 & 0.5934   & 0.5584 	& 0.5539	& 0.3753	\\ \hline
			\end{tabular}}
		\end{minipage}
	\end{table}
\begin{figure}[h]
...
\begin{tikzpicture}
 \begin{axis}[
	...
	ymajorgrids = true,]
		...
		\addplot coordinates {(0,0.6405)};    
		\addplot coordinates {(1,0.6382)};    
		\addplot coordinates {(2,0.643)};    
		\addplot coordinates {(3,0.6372)};
		\addplot coordinates {(4,0.5583)};
        %\legend{BC, BTC, BWC, BEC, Random}
     \end{axis}
\end{tikzpicture}\captionof{figure}{Group size 4}
\end{minipage}
\begin{minipage}{.46\textwidth}\centering
\begin{tikzpicture}
 \begin{axis}[
	...
	ymajorgrids = true,]
		...
		\addplot coordinates {(0,0.5887)};    
		\addplot coordinates {(1,0.5764)};    
		\addplot coordinates {(2,0.5901)};    
		\addplot coordinates {(3,0.5867)};
		\addplot coordinates {(4,0.4597)}; 
        %\legend{BC, BTC, BWC, BEC, Random}
     \end{axis}
\end{tikzpicture}\captionof{figure}{Group size 12}
\end{minipage}
\end{figure}
\end{frame}