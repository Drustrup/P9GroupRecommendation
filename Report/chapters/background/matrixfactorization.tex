...
In Funk's blog, he used the gradient descent optimization algorithm to learn the A and B matrices to minimize the error.
...
\end{equation}
\todo{n is currently undefined. Split M into 2 loops.}
