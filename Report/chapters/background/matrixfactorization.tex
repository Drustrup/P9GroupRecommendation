...
\begin{figure} [H] \label{fig:svd_ab_squeeze}
	\centering
...
However this alone is not enough to get useful predictions. SVD functions by extending the knowledge of the latent factors from the known ratings onto the unknown ratings.
