...
As data sparsity grows in a set, the less accurate every method gets. Factorization methods counteract this by compressing the data, making it less sparse, and easier to cluster.\todo{Make more concrete}
...
Given a function, steps are taken towards the negative of the gradient of the function.
...
Taking the average error when finding the derivative is a costly operation.

\begin{equation}\label{eq:}
	\text{Running time of Gradient Descent}
\end{equation}
