...
% Is our STBV implemented in a proper way (we introduced an element of strategic voting in an attempt to insure every user has a good chance of having at least one of their preferences in the selection)