...
BTC ability to satisfy larger groups becomes truly apparent with a group size of 12 and 16, Figure \ref{fig:testresult12members} and Figure \ref{fig:testresult16members}, where it is about 6.4\% and 11.2\% better respectively. An interesting observation is that BTC gives a slightly worse satisfaction with a size of 12 than when the size is 16. The cause of this dip in satisfaction is unknown, however it could be interesting to explore it further. BC, BWC, and BEC all perform within 1\% of each other, with BEC performing slightly worse than the other two.

When the group size reaches 20, Figure \ref{fig:testresult20members}, BTC also outperforms the other methods the most, at least with the group sizes tested. On average it outperforms BC by about 13.1\%. However after size 20, the benefits of BTC seems to gradually fall away, as Figure \ref{fig:testresult40members} shows, at a group size of 40 BTC has had a larger drop in satisfaction than the other methods 
...
\section{Influence of the Size of k} \label{sec:influenceofk}